...
function mime_structure ($bodystructure, $flags=array()) {
    ...
    if (!is_object($msg)) {
        ...
        $errormessage .= '<table><tr><td>' . sq_htmlspecialchars($read) . '</td></tr></table>';
...
function formatAttachments($message, $exclude_id, $mailbox, $id) {
    ...
    foreach ($att_ar as $att) {
        ...
        $attachments .= '<tr><td>' .
            ...
            '</b>&nbsp;&nbsp;</small></td>' .
            '<td><small>[ '.sq_htmlspecialchars($type0).'/'.htmlspecialchars($type1).' ]&nbsp;</small></td>' .
            '<td><small>';
            ...
            switch ($encoding)
            {
                case 'B':
                    ...
                    if ($can_be_encoded) {
                        ...
                        $replace = sq_htmlspecialchars($replace);
                    }
                    $ret.= $replace;
                    break;
                case 'Q':
